...
```bash
# Download specific version (replace v1.0.59 with desired version)
wget https://github.com/linescripts/timenzo/raw/v1.0.59/Timenzo-1.0.59-f4a597b.sh

# Make executable
chmod +x Timenzo-1.0.59-f4a597b.sh

# Run installer
./Timenzo-1.0.59-f4a597b.sh
```

Available files in each version branch:
- `timenzo-installer.sh` - Generic filename (same across all versions)
- `Timenzo-1.0.59-f4a597b.sh` - Version-specific filename
