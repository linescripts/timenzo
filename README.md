...
```bash
# Download specific version (replace v1.0.50 with desired version)
wget https://github.com/linescripts/timenzo/raw/v1.0.50/Timenzo-1.0.50-a83c2fe.sh

# Make executable
chmod +x Timenzo-1.0.50-a83c2fe.sh

# Run installer
./Timenzo-1.0.50-a83c2fe.sh
```

Available files in each version branch:
- `timenzo-installer.sh` - Generic filename (same across all versions)
- `Timenzo-1.0.50-a83c2fe.sh` - Version-specific filename
