...
```bash
# Download specific version (replace v1.0.30 with desired version)
wget https://github.com/linescripts/timenzo/raw/v1.0.30/Timenzo-1.0.30-612b826.sh
...
chmod +x Timenzo-1.0.30-612b826.sh

# Run the installer
./Timenzo-1.0.30-612b826.sh
```
