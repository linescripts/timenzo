...
```bash
# Download specific version (replace v1.0.54 with desired version)
wget https://github.com/linescripts/timenzo/raw/v1.0.54/Timenzo-1.0.54-32b89aa.sh

# Make executable
chmod +x Timenzo-1.0.54-32b89aa.sh

# Run installer
./Timenzo-1.0.54-32b89aa.sh
```

Available files in each version branch:
- `timenzo-installer.sh` - Generic filename (same across all versions)
- `Timenzo-1.0.54-32b89aa.sh` - Version-specific filename
